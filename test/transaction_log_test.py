...
class TransactionLogTest(unittest.TestCase):
    ...
    def setUp(self):
        log = [{'transactionJson': {'contractID': 'good_contract_id'}, 'timestamp': '2018-01-01 00:00:00.000'},
               {'transactionJson': {'contractID': 'last_contract_id'}, 'timestamp': '2018-01-03 00:00:00.000'},
               {'transactionJson': {'contractID': 'good_contract_id'}, 'timestamp': '2018-01-02 00:00:00.000'}]
    ...
    def test_get_last_transaction(self):
        ...
        self.assertEquals(last_transaction, {'contractID': 'last_contract_id'})
